...
import { burst, ring, onPlayerDash } from './fx.js';
  ...
  if (s) {
    if (a.vy > 0) {
      ...
      if (a.bounce > 0 && a.dashTime > 0 && a.dashDY > 0.35) {
        ...
        screen.trauma = Math.min(1, screen.trauma + 0.45);
